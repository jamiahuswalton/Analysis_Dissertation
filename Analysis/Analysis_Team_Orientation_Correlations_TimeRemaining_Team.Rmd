---
title: 'Dissertation Analysis: Correlations - Time Remaining (Team)- Team Orientation'
...
When grouping paired responses for correct collection rate and performance (reverse) by Target, the results show a __significant__ positive correlation for Ind ($\tau_b = 0.2861912 $), Team($\tau_b =  0.2463834$), and IaT($\tau_b = 0.204452$), indicating a correct perception of team performance. 
...
When grouping paired responses for correct collection rate and performance (reverse) by session order, the results showed a __significant__ positive correlation session 3 ($\tau_b = 0.180931 $) and 4 ($\tau_b = 0.3625354$).
...
When grouping paired responses for correct collection rate and performance (reverse) by target and session order, the results showed a __significant__ positive correlations in Individual in Session 3 ($\tau_b = 0.291859$), Ind_Team in sesion 3 ($\tau_b = 0.2729653$), Individual in session 4 ($\tau_b = 0.5560463$), and Team in Session 4 ($\tau_b = 0.3885878$).
