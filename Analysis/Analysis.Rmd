...
# Response variable
response_variable <- "timeRemaining_team"
plot_dependent_variable_name <- "TimeRemaining"
...
data_modified_team <- team_data %>%
  select(TeamScore,
         ...
         SessionOrder, 
         Team) %>%
  mutate(sqrt.value = sqrt(.data[[response_variable]]))
...
ggplot(model.NoInteraction, aes(x = .resid)) +
  ...
  labs(title = paste("Histogram of Residuals for model.NoInteraction"), x = "", y = "") +
  theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("Histogram_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction_Team.png", sep = ""))
...
ggplot(model.NoInteraction, aes(x = .fitted, y = .resid)) +
  ...
  labs(title = paste("Fitted-Value Plot for model.NoInteraction"), x = "Fitted Values", y = "Residuals") +
  theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("FitteValue_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction_Team.png", sep = ""))
...
ggplot(model.NoInteraction, aes(sample = .resid)) +
  ...
  labs(title = "Normal Q-Q Plot for model.NoInteraction", x = "Theoretical", y = "Sample") +
   theme(plot.title = element_text(hjust = 0.5)) + 
  ggsave(paste("QQ_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction_Team.png", sep = ""))
...
ggplot(model.NoInteraction.NoTarget, aes(x = .resid)) +
  ...
  labs(title = paste("Histogram of Residuals for model.NoInteraction.NoTarget"), x = "", y = "") +
  theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("Histogram_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction.NoTarget_Team.png", sep = ""))
...
ggplot(model.NoInteraction.NoTarget, aes(x = .fitted, y = .resid)) +
  ...
  labs(title = paste("Fitted-Value Plot for model.NoInteraction.NoTarget"), x = "Fitted Values", y = "Residuals") +
  theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("FittedValue_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction.NoTarget_Team.png", sep = ""))
...
ggplot(model.NoInteraction.NoTarget, aes(sample = .resid)) +
  ...
  labs(title = "Normal Q-Q Plot for NoInteraction.NoTarget", x = "Theoretical", y = "Sample") +
   theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("QQ_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction.NoTarget_Team.png", sep = ""))
```
...
data_modified_ind <- ind_data %>%
  select(response_variable,
         ...
         Team, 
         Player_ID) %>%
  mutate(sqrt.value = sqrt(ifelse(.data[[response_variable]] < 0, 0, .data[[response_variable]]))) # Some of the time remaining vaules are negative when the should be zero. I want to make sure those values are zero
...
ggplot(model.NoInteraction, aes(x = .resid)) +
  ...
  labs(title = paste("Histogram of Residuals for model.NoInteraction"), x = "", y = "") +
  theme(plot.title = element_text(hjust = 0.5)) + 
  ggsave(paste("Histogram_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction_Ind.png", sep =""))
...
ggplot(model.NoInteraction, aes(x = .fitted, y = .resid)) +
  ...
  labs(title = paste("Fitted-Value Plot for model.NoInteraction"), x = "Fitted Values", y = "Residuals") +
  theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("FittedValue_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction_Ind.png", sep =""))
...
ggplot(model.NoInteraction, aes(sample = .resid)) +
  ...
  labs(title = "Normal Q-Q Plot for NoInteraction", x = "Theoretical", y = "Sample") +
  theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("QQ_Residuals_", plot_dependent_variable_name, "_sqrt_NoInteraction_Ind.png", sep =""))
...
data_modified_ind <- ind_data %>%
  select(response_variable,
         ...
         Team, 
         Player_ID) %>%
  mutate(sqrt.value = sqrt(ifelse(.data[[response_variable]] < 0, 0, .data[[response_variable]]))) # Some fo the time remaining vaules are negative when the should be zero. I want to make sure those values are zero
...
ggplot(model.NoInteraction.NoTarget, aes(x = .resid)) +
  ...
  labs(title = paste("Histogram of Residuals for model.NoInteraction.NoTarget"), x = "", y = "") +
  theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("Histogram_Residuals_", plot_dependent_variable_name, "_NoInteraction.NoTarget_Ind.png", sep =""))
...
ggplot(model.NoInteraction.NoTarget, aes(x = .fitted, y = .resid)) +
  ...
  labs(title = paste("Fitted-Value Plot for model.NoInteraction.NoTarget"), x = "Fitted Values", y = "Residuals") +
  theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("FittedValue_Residuals_", plot_dependent_variable_name, "_NoInteraction.NoTarget_Ind.png", sep =""))
...
ggplot(model.NoInteraction.NoTarget, aes(sample = .resid)) +
  ...
  labs(title = "Normal Q-Q Plot for model.NoInteraction.NoTarget", x = "Theoretical", y = "Sample") +
   theme(plot.title = element_text(hjust = 0.5)) +
  ggsave(paste("QQ_Residuals_", plot_dependent_variable_name, "_NoInteraction.NoTarget_Ind.png", sep =""))
```
...
### Q: Is there exciting variation among the *incorrect items collected* metric that will help me understand the influence of the feedback condition?
...
y_label_team <- "Count"
x_label_team <- "Incorrect items collected"
title_response_team <- "Distribution of Incorrect items collected (Team)"
plot_name <- "Histogram_II_Team.png"
setwd(figure_directory)
...
x_label_team <- "Target"
title_response_team <- "Distribution of Incorrect Items Collected (Team)"
plot_name <- "Histogram_II_ByTarget_Team.png"
setwd(figure_directory)
...
y_label_ind <- "Count"
x_label_ind <- "Incorrect items collected"
title_response_ind <- "Distribution of Incorrect Items Collected (Individual)"
plot_name <- "Histogram_II_Ind.png"
setwd(figure_directory)
...
x_label_ind <- "Incorrect items collected"
title_response_ind <- "Distribution of Incorrect Items Collected (Individual)"
plot_name <- "Histogram_II_ByTarget_Ind.png"
setwd(figure_directory)
...
### Q: Is there exciting variation among the *incorrect items collected* that explains how the feedback conditions influence the *incorrect items collected* when session order is taken into consideration?
...
x_label_team <- "Incorrect items collected"
title_response_team <- "Distribution of Incorrect Items collected (Team)"
plot_name <- "Histogram_II_ByTarget_BySessionOrder_Team.png"
setwd(figure_directory)
...
x_label_ind <- "Incorrect items collected"
title_response_ind <- "Distribution of Incorrect Items collected (Individual)"
plot_name <- "Histogram_II_ByTarget_BySessionOrder_Ind.png"
setwd(figure_directory)
...
### Q: Is there an *interaction* between the Target and Session Order for the __incorrect items collected__?
...
```{r}
dependent_response_team <- "II_team"
y_label_team <- "Incorrect items collected"
x_label_team <- "Target"
title_response_team <- "Incorrect items collected (Team) Vs. Target"
plot_name <- "InteractionPlot_II_ByTarget_BySessionOrder_Team.png"
setwd(figure_directory)
...
y_label_team <- "Incorrect items collected"
x_label_team <- "Target"
title_response_team <- "Incorrect items collected (Team) Vs. Session Order"
plot_name <- "InteractionPlot_II_BySessionOrder_ByTarget_Team.png"
setwd(figure_directory)
...
```{r}
dependent_response_ind <- "II_ind"
y_label_ind <- "Incorrect items collected"
x_label_ind <- "Target"
title_response_ind <- "Incorrect items collected (Individual) Vs. Target"
plot_name <- "InteractionPlot_II_ByTarget_BySessionOrder_Ind.png"
setwd(figure_directory)
...
x_label_ind <- "Target"
title_response_ind <- "Incorrect items collected (Individual) Vs. Target"
plot_name <- "InteractionPlot_II_BySessionOrder_ByTarget_Ind.png"
setwd(figure_directory)
...
### Q: Is there an interaction between the Target and Session Order for the __incorrect items collected__ that is statistically significant?
