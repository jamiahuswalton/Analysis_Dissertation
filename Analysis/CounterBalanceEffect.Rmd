...
params:
  # Team
  dependent_team: "TeamScore"
  dependent_team_name_WithSpace: "Team Score"
  
  #Individual
  dependent_ind: "IndividualScore"
---
...
The figure above shows the team scores in different counter balance sets across session 2, 3, and 4. Generally, it looks like team score improves over time in each counter balance session. Counter balance set 5 looks overall lower than the over sets. 
