---
title: 'Dissertation Analysis: Time Remaining'
...
ggplot(data = plot_data_team, 
       aes(x = factor(SessionOrder), 
                  ...
                  group = rank_order,
                  label = names )) +
  geom_text(position = position_dodge(1), vjust = 0, aes(y = .data[[params$dependent_response_team]] + 15), check_overlap = FALSE) +
