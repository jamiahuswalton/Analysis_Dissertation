...
kable(r.squaredGLMM(model.NoInteraction.NoTarget),
      caption = "Table: Effect size for *No Interaction and No Target*") %>%
   kable_styling(full_width = F)

kable(r.squaredGLMM(model.NoInteraction),
      caption = "Table: Effect size for *No Interaction*") %>%
   kable_styling(full_width = F)
...
It looks like there is some assumption violation for both models. 
...
kable(compare(model.NoInteraction, rmodel.NoInteraction, show.rho.functions = FALSE),
      caption = "model.NoInteraction")
...
kable(compare(model.NoInteraction.NoTarget, rmodel.NoInteraction.NoTarget, show.rho.functions = FALSE), 
      caption = "model.NoInteraction.NoTarget")
```
...
emmeans(model.NoInteraction, list(pairwise ~ Target), adjust = "tukey")
```
The results show a significant difference between the Int_Team and Team level of feedback. The difference indicates that the amount of time remaining in the Team feedback condition results in higher time remaining. 
